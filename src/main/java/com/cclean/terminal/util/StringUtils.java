...
public class StringUtils {
    ...
    public static Date integerConverDate(String str) {
        Date date = null;
    ...
    public static Date convertDate(String str) {
        ...
        SimpleDateFormat sDateFormat = null;
        try {
            String pattern = "^\\s*\\d{4}-\\d+-\\d+\\s+\\d+:\\d+:\\d+\\s*$";
            String pattern2 = "^\\s*\\d{4}-\\d+-\\d+\\s*$";
    ...
    public static String backDay(String str, Integer i) {

        Date date = integerConverDate(str);
    ...
    public static String goDay(String str, Integer i) {
    ...
    public static void main(String[] a) {
       /* String escapeXML = escapeXML("\\");
        ...
        System.out.println(returnPercent(2, 3));
    }

    public static String returnPercent(Integer num1, Integer num2) {
